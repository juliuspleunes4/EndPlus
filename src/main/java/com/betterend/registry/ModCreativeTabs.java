package com.betterend.registry;
...
public class ModCreativeTabs {
    ...
    public static final ItemGroup BETTEREND_GROUP = Registry.register(
            Registries.ITEM_GROUP,
            Identifier.of(BetterEnd.MOD_ID, "main"),
            FabricItemGroup.builder()
                    .icon(() -> new ItemStack(ModItems.DRAGON_HEART))
                    .displayName(Text.translatable("itemGroup.betterend.main"))
